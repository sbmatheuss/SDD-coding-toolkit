#!/usr/bin/env python3
# Vendored from ag-kit (github.com/vudovn/ag-kit) @ 20a13da6d4414c7c6ae33db050a9c606eaef9f40 :: .agents/skills/performance-profiling/scripts/lighthouse_audit.py. MIT (c) vudovn.
"""
